...
import { tableMoneyRender, tableMonthTypeRender } from 'ADMIN_UTILS/tableItemRender';
...
const createDataSet = (data) => {
    ...
    data.forEach((row) => {
        fixedData.push([
            ...
            { value: (row['Amount'] == '-1' ? '' : tableMoneyRender(row['Amount'])) },
            { value: row['EntryDate'] },
            ...
            { value: tableMonthTypeRender(row['SalaryType']), style: { fill: { fgColor: { rgb: "FFCCEEFF" } } } },
