...
class SearchForm extends Component {
    startQuery = (e) => {
        ...
        this.props.form.validateFields((err, fieldsValue) => {
            ...
            const { startQuery, resetPageCurrent } = this.props.monthlyWageBillDetailStore;
            resetPageCurrent();
            startQuery();
        });
    }
...
SearchForm = Form.create({
    mapPropsToFields: props => {
        const { view: { searchValue } } = props.monthlyWageBillDetailStore;
        return createFormField(searchValue);
    },
    onValuesChange: (props, changedValues, allValues) => {
        props.monthlyWageBillDetailStore.handleFormValuesChange(allValues);
    }
})(SearchForm);
