...
class WeekSplit extends Component {
    ...
    startQuery = async () => {
        ...
        let reqParam = {
            EntId,
            TrgtSpId,
            BeginDt: BeginDt ? moment(BeginDt).format('YYYY-MM-DD') : "",
            EndDt: EndDt ? moment(EndDt).format('YYYY-MM-DD') : "",
            // 月份后端查询需要加上-01  2019年11月28日修改
            BillRelatedMo: BillRelatedMo ? moment(BillRelatedMo).format('YYYY-MM') + '-01' : "",
            SettlementTyp,
