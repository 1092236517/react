...
class InfoModal extends Component {
    saveData = (e) => {
        this.props.form.validateFields((err, fieldsValue) => {
            ...
            this.props.profitStore.showAndHideModal('ok');
        });
    }
                    ...
                    <FormItem {...formItemLayout} label='导入文件'>
                        {getFieldDecorator('ImportFileOriginName', {
                            ...
                            <AliyunUpload
                                ...
                                listType="text"
                                oss={uploadRule.profitJust[uploadJustType]}
                                maxNum={1}
...
InfoModal = Form.create({
    mapPropsToFields: props => {
        const { infoModal } = props.profitStore.view;
    ...
    onValuesChange: (props, changedValues, allValues) => {
        props.profitStore.handleModalFormValuesChange(allValues);
    }
})(InfoModal);
