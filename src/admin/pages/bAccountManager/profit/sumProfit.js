...
class SumProfit extends Component {
    ...
    exportRecord = async (flag) => {
        ...
        try {
            window._czc.push(['_trackEvent', 'z盈利报表', flag ? '导出中介费' : '导出服务费', 'z盈利报表_Y结算']);
    ...
    platBtn = () => {
        window._czc.push(['_trackEvent', 'z盈利报表', '中介费', 'z盈利报表_Y结算']);
        this.setState({
            onPlatBtn: true,
            pageSize: 10,
            current: 1
    ...
    srvBtn = () => {
        window._czc.push(['_trackEvent', 'z盈利报表', '服务费', 'z盈利报表_Y结算']);
        this.setState({
            onPlatBtn: false,
            pageSize: 10,
            current: 1
