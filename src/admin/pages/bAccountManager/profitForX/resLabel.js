...
export default class extends PureComponent {
    render() {
        const {
            TolRemainingSalary = 0, TolReturnFee = 0, TolSumPay = 0, TolXArrears = 0, TolSumProfit = 0, TolWeeklyPaidAmt = 0, TolXEnd = 0, TolXImport = 0, TotSumProfit = 0, TolXPaidBIllAmt = 0, TolSubsidy = 0
        } = this.props;
            ...
            <div className='color-danger mb-16'>
                ...
                <div>
                    其中已支生活费：{convertCentToThousandth(TolWeeklyPaidAmt)}元，
                        ...
                        总返费：{convertCentToThousandth(TolReturnFee)}元。
                    </div>
            </div>
        );
    }
