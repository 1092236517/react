        ...
        return (
            <Modal
                ...
                <div className='text-center' style={{ padding: '20px 0' }}>
                    ...
                    <div>
                        <Button type='primary' onClick={auditBill.bind(this, batchID, 1)}>同意</Button>
                        <Button type='primary' className='ml-8' onClick={auditBill.bind(this, batchID, 2)}>不同意</Button>
