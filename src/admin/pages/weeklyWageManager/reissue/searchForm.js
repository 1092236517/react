...
class SearchForm extends Component {
    generateTable = (e) => {
        ...
        this.props.form.validateFields((err, fieldsValue) => {
            ...
            const { view: { tableVisible }, handleFormValuesChange, showNewTable } = this.props.weeklyWageReissueStore;
            ...
            if (tableVisible) {
                Modal.confirm({
                    ...
                    onOk: () => {
                        ...
                        window._czc.push(['_trackEvent', '周薪补发', '生成表格', '周薪补发_Y结算']);
                    }
                });
            } else {
                showNewTable();
    ...
    render() {
        ...
        const { view: { tableVisible } } = this.props.weeklyWageReissueStore;
        const { generateTableX } = resId.weeklyWageManager.reissue;
...
SearchForm = Form.create({
    mapPropsToFields: props => {
        const { view: { searchValue } } = props.weeklyWageReissueStore;
