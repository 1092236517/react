...
class InfoModal extends Component {
    ...
    saveData = (e) => {
        ...
        window._czc.push(['_trackEvent', '会员打款虚拟子账户', record ? '修改' : '新增', '会员打款虚拟子账户_Y结算']);
    ...
    render() {
        ...
        return (
            <Modal
                ...
                title={record ? '修改' : '新增'}
                onOk={this.saveData}
                onCancel={() => { setInfoModalShow(false); window._czc.push(['_trackEvent', '会员打款虚拟子账户', '取消', '会员打款虚拟子账户_Y结算']); }}>
