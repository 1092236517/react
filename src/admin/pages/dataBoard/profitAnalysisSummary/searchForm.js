...
class SearchForm extends Component {
    startQuery = (e) => {
        ...
        this.props.form.validateFields((err, fieldsValue) => {
            ...
            const { IntvDtStart, IntvDtEnd, EntryDtStart, EntryDtEnd, EntId, TrgtSpId, SettlementTyp } = fieldsValue;
            if (!IntvDtStart && !IntvDtEnd && !EntryDtStart && !EntryDtEnd && !EntId && !TrgtSpId && !SettlementTyp) {
            ...
            resetPageCurrent();
            startQuery();
            window._czc.push(['_trackEvent', 'zx盈利分析总报表', '查询', 'zx盈利分析总报表_N非结算']);
        });
    }
