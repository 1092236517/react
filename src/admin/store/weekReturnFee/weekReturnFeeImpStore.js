...
import { impCheck, geneBatchByBizID, getImpCheckRes, getGeneBatchRes, getResFromAliyun, expPreview } from 'ADMIN_SERVICE/ZXX_WeekReturnFee';
...
export default class extends BaseViewStore {
    ...
    importPreview = async () => {
        ...
        try {
            ...
            let resData = await impCheck(reqParam);
    ...
    switchAgent = (agentID) => {
        ...
        window._czc.push(['_trackEvent', '导入返费周薪', 'switchAgent按钮点击', '导入返费周薪_N非结算']);
    }
    ...
    generateBatch = async () => {
        ...
        try {
            view.showSpin = true;
            let resData = await geneBatchByBizID(reqParam);
