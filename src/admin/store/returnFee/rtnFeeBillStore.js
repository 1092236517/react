...
export default class extends BaseViewStore {
    ...
    startQuery = async () => {
        ...
        const {
            searchValue: {
                EntId, TrgtSpId, ReturnFeeBillId, AuditStartTm, AuditEndTm, IntvDtStart, IntvDtEnd
            },
            pagination: {
                current, pageSize
            }
    ...
    exportRecord = async () => {
        const view = this.view;
        const { EntId, TrgtSpId, ReturnFeeBillId, IntvDtStart, IntvDtEnd, AuditStartTm, AuditEndTm } = view.searchValue;
